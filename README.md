...
[![Language](https://img.shields.io/static/v1?label=language&message=English%20%7C%20French%20%7C%20German%20%7C%20Italian%20%7C%20Korean%20%7C%20Polish%20%7C%20Brazilian%20Portuguese%20%7C%20Russian%20%7C%20Simplified%20Chinese%20%7C%20Spanish&color=limegreen)](https://github.com/Argent77/A7-HiddenGameplayOptions)
...
This is a convenience option that allows you to install all available game options at once. The improved Cheat Menu and other GUI improvements are not included. See more detailed information about individual options below.

**The following components are available if you skip the component "Install Hidden Gameplay Options at once":**

#### 2. Update resource tables for "Improved Cheat Menu"
...
#### 11. Add in-game option "Critical Hit Screen Shake"
...
#### 12. Add in-game option "Show extra combat info"
...
#### 13. Add in-game option "Show Game Date and Time on Pause"

Setting this option shows game date and time when activating pause.

*Option can be found in Gameplay > Feedback > Feedback Messages.*

#### 14. Add in-game option "Disable Area Map Zoom" *(only available for PST:EE)*
...
#### 15. Add in-game option "Reverse Mouse Wheel Zoom"

Setting this option reverses zoom direction when using the mouse wheel.

*Option can be found in Graphics > Display Options.*

#### 16. Add in-game option "Pause Game on Map Screen"

Setting this option causes the game to pause whenever the map screen is active.

*Option can be found in Graphics > Display Options.*

#### 17. Add in-game option "Enable Fog" *(not available for PST:EE)*

Setting this option enables fog effects on maps.

*Option can be found in Graphics > Display Options.*

#### 18. Add in-game option "Disable Movies"

Enabling this option disables movie playback.

*Option can be found in Graphics > Display Options.*

#### 19. Add in-game option "No Cosmetic Attacks" *(only available for PST:EE)*
...
#### 20. Add in-game option "XP Bonus in Nightmare Mode" *(not available for PST:EE)*
...
#### 21. Add in-game option "Trigger Bored Sounds" *(not compatible with Lefreut's Enhanced UI (LeUI))*
...
#### 22. Add in-game option "Frame Rate" (experimental) *(not available for PST:EE, not compatible with Lefreut's Enhanced UI (LeUI) and K4f4r's Classic BG UI)*
...
#### 23. Add in-game option "Action Feedback" *(not compatible with Lefreut's Enhanced UI (LeUI), K4f4r's Classic BG UI and Tipun's User Interface)*
...
#### 24. Add in-game option "Enable Level Up Icon" *(only available for PST:EE, requires "Level Up" Icon Tweaks)*
...
#### 25. Add in-game option "Show Area of Effect Range" *(not available for PST:EE)*
...
#### 31. Add in-game options for Tweak Anthology's "Create Interval Saves" *(requires Tweaks Anthology component "Create interval saves")*
...
#### 32. Add in-game option "Force Dialog Pause"
...
#### 33. Add in-game option for Tweak Anthology's "Restored Loading Hints" *(requires Tweaks Anthology component "Restored Loading Hints")*

Enabling this option shows loading hints from original Baldur's Gate II in the log window of the game. This option requires Tweaks Anthology's mod component "Restored Loading Hints" to be installed.
...
This option can be used to update the resource tables of the improved cheat menu which can be helpful if other content mods are installed afterwards. It isn't registered in the WeiDU.log and can therefore be executed as often as desired.


### Group: GUI Improvements

*This is a loose collection of minor improvements that focuses on various visual and usability aspects of the GUI. They are currently only available for the default GUIs of the supported games.*

#### 1. Improved "Death Screen" options

The death screen is shown after the protagonist or the whole party is killed and provides options to quit or load a game. This component expands the dialog by the option to automatically load the last save if available.

#### 2. Improved "Quit Game" options

Pressing Alt-F4 brings up a dialog with the options to quit the game or cancel the request. This component expands the dialog by the option to go to the start screen of the game instead.

#### 3. Game Menu: Fire animation over SoD logo (SoD and EET only)

The start screen of the game shows a nifty fire animation over the game logo if the "Siege of Dragonspear" campaign is active. This component adds the same fire animation to the options menu that can be brought up by pressing the `ESC` key or /*Options* button in a running game.

#### 4. Game Menu: Improved "Quit Game" options (IWD:EE only)

Pressing "Quit Game" from the options menu in a running game provides the options "Cancel", "Quit", and "Save" where the "Quit" option just returns to the start screen of the game. This component changes the "Quit" option to quit the game completely and adds another option "Main Menu" that returns to the start screen of the game instead.

#### 5. Game Menu: Improved "Load Game" options

Pressing "Load Game" from the options menu in a running game provides the options "Cancel" and "Load". This component adds a third option to continue from the last save instead, if available.
