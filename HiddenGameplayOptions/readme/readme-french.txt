...
aussi compatible avec "Dragonspear UI ++" de Pecca, Lefreut's Enhanced UI (LeUI), 
Classic BG UI de K4f4r et l'interface Tipun_Gui.
...
3. Mise à jour des fichiers existants pour le composant "Écran de triche amélioré"
...
4. Ajouter l'option de jeu "Activer le Mode de débogage"
...
5. Ajouter l'option de jeu "Activer le mode de modification de l'interface utilisateur (UI)"
...
6. Ajouter l'option de jeu "Afficher les numéros des textes"
...
7. Ajouter l'option de jeu "Afficher les raccourcis clavier dans les bulles d'aide"
...
8. Ajouter l'option de jeu "Afficher les icônes de zone sensible avec la tabulation"
...
9. Ajouter l'option de jeu "Utiliser la barre d'espace dans les dialogues" (disponible uniquement
   pour PST:EE)
...
10. Ajouter l'option de jeu "Limiter les sorts de druide pour les Clercs/Rôdeurs" (pas disponible
   dans PST:EE)
...
11. Ajouter l'option de jeu "Attaque sournoise 3e Édition"
...
12. Ajouter l'option de jeu "Secouer l'écran en cas de coup critique"
...
13. Ajouter l'option de jeu "Informations de combat supplémentaires"
...
14. Ajouter l'option de jeu "Afficher la date et l'heure du jeu pendant les pauses"
...
15. Ajouter l'option de jeu "Désactiver le zoom dans la vue de la carte" (disponible uniquement
    pour PST:EE)
...
16. Ajouter l'option de jeu "Inverser le zoom de la molette de la souris"
...
17. Ajouter l'option de jeu "Mettre le jeu en pause dans l'écran de la carte de la zone"
...
18. Ajouter l'option de jeu "Activer le brouillard" (pas disponible dans PST:EE)
...
19. Ajouter l'option de jeu "Désactiver les films"
...
20. Ajouter l'option de jeu "Aucune attaque cosmétique" (uniquement disponible pour PST:EE)
...
21. Ajouter l'option de jeu "Bonus d'expérience en mode cauchemar" (pas disponible dans PST:EE)
...
22. Ajouter l'option de jeu "Émettre des sons d'ennui" (incompatible avec Lefreut's Enhanced UI - LeUI)
...
23. Ajouter l'option de jeu "Nombre d'images par seconde" (expérimental) (pas disponible dans PST:EE,
...
24. Ajouter l'option de jeu "Feedback d'actions" (Incompatible avec Lefreut's Enhanced UI - LeUI, 
    Classic BG UI de K4f4r et l'interface Tipun_Gui)
...
25. Ajouter l'option de jeu "Afficher l'icône de passage au niveau supérieur" (uniquement disponible
...
26. Ajouter l'option de jeu "Afficher la portée des zones d'effet des sorts" (pas disponible dans PST:EE)
...
27. Ajouter l'option de jeu "Recherche d'itinéraire améliorée"
...
28. Ajouter l'option de jeu "Faire disparaître la surbrillance des pièges" (pas disponible dans PST:EE)
...
29. Ajouter l'option de jeu "Afficher les sorts à apprendre"
...
30. Ajouter l'option de jeu "Afficher la carte des déplacements"
...
31. Ajouter l'option de jeu "Afficher la carte dynamique des obstacles"
...
32. Ajouter les options de jeu pour le composant "Créer des sauvegardes périodiques" de Tweaks Anthology
...
33. Ajouter l'option de jeu "Forcer la mise en pause pendant les dialogues"
