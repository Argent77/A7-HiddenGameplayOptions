...
The mod supports all Enhanced Edition games patched to v2.0 or higher. It is also fully compatible
with Pecca's "Dragonspear UI++", "Infinity UI++" and IWDEE-UI-BGEE, and largely compatible with
all of Lefreut's Enhanced UI variants, K4f4r's Classic BG UI, and Tipun's User Interface.
...
32. Add in-game option for Tweak Anthology's "Restored Loading Hints" (requires Tweaks Anthology
